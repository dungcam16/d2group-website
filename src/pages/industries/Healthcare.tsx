...
import { CheckCircle, TrendingUp, Clock, Users, Heart, MessageCircle, BarChart3, Stethoscope, Zap, Calendar } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              Chatbot AI giúp bệnh viện và phòng khám tự động hóa đặt lịch khám, 
              tư vấn sức khỏe ban đầu, và chăm sóc bệnh nhân 24/7.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-green-200 hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <TrendingUp className="h-12 w-12 text-green-600 mx-auto mb-2" />
                  <CardTitle className="text-2xl text-green-600">+200%</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-center text-gray-600">Đặt lịch khám online</p>
                </CardContent>
              </Card>
              <Card className="border-teal-200 hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <Clock className="h-12 w-12 text-teal-600 mx-auto mb-2" />
                  <CardTitle className="text-2xl text-teal-600">-60%</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-center text-gray-600">Thời gian chờ bệnh nhân</p>
                </CardContent>
              </Card>
              <Card className="border-cyan-200 hover:shadow-lg transition-shadow">
                <CardHeader className="text-center">
                  <BarChart3 className="h-12 w-12 text-cyan-600 mx-auto mb-2" />
                  <CardTitle className="text-2xl text-cyan-600">2–4 tháng</CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 to-cyan-600 text-white text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-6">Chuyển đổi số Y tế</h2>
          <p className="text-xl mb-8 text-teal-100 max-w-2xl mx-auto">
            Cải thiện trải nghiệm bệnh nhân và hiệu quả vận hành
          </p>
          <Button size="lg" className="bg-white text-teal-600 hover:bg-teal-50 font-bold px-12 py-4 text-lg">
