...
const CaseStudies = () => {
  ...
  const caseStudies = [
    {
      id: 1,
      titleKey: "caseStudies.studies.techmart.title",
      companyKey: "caseStudies.studies.techmart.company",
      industryKey: "caseStudies.studies.techmart.industry",
      challengeKey: "caseStudies.studies.techmart.challenge",
      solutionKey: "caseStudies.studies.techmart.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.techmart.testimonial",
      authorKey: "caseStudies.studies.techmart.author"
    },
    {
      id: 2,
      titleKey: "caseStudies.studies.medcare.title",
      companyKey: "caseStudies.studies.medcare.company",
      industryKey: "caseStudies.studies.medcare.industry",
      challengeKey: "caseStudies.studies.medcare.challenge",
      solutionKey: "caseStudies.studies.medcare.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.medcare.testimonial",
      authorKey: "caseStudies.studies.medcare.author"
    },
    {
      id: 3,
      titleKey: "caseStudies.studies.vietfinance.title",
      companyKey: "caseStudies.studies.vietfinance.company",
      industryKey: "caseStudies.studies.vietfinance.industry",
      challengeKey: "caseStudies.studies.vietfinance.challenge",
      solutionKey: "caseStudies.studies.vietfinance.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.vietfinance.testimonial",
      authorKey: "caseStudies.studies.vietfinance.author"
    },
    {
      id: 4,
      titleKey: "caseStudies.studies.edutech.title",
      companyKey: "caseStudies.studies.edutech.company",
      industryKey: "caseStudies.studies.edutech.industry",
      challengeKey: "caseStudies.studies.edutech.challenge",
      solutionKey: "caseStudies.studies.edutech.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.edutech.testimonial",
      authorKey: "caseStudies.studies.edutech.author"
    },
    {
      id: 5,
      titleKey: "caseStudies.studies.propertypro.title",
      companyKey: "caseStudies.studies.propertypro.company",
      industryKey: "caseStudies.studies.propertypro.industry",
      challengeKey: "caseStudies.studies.propertypro.challenge",
      solutionKey: "caseStudies.studies.propertypro.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.propertypro.testimonial",
      authorKey: "caseStudies.studies.propertypro.author"
    },
    {
      id: 6,
      titleKey: "caseStudies.studies.luxuryresorts.title",
      companyKey: "caseStudies.studies.luxuryresorts.company",
      industryKey: "caseStudies.studies.luxuryresorts.industry",
      challengeKey: "caseStudies.studies.luxuryresorts.challenge",
      solutionKey: "caseStudies.studies.luxuryresorts.solution",
      results: [
      ...
      testimonialKey: "caseStudies.studies.luxuryresorts.testimonial",
      authorKey: "caseStudies.studies.luxuryresorts.author"
    }
  ];
    ...
    <div className="pt-16">
      ...
      <Section background="gray">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {[
            { nameKey: "caseStudies.industries.list.ecommerce", icon: "🛒", metricKey: "caseStudies.industries.metrics.ecommerce" },
            { nameKey: "caseStudies.industries.list.healthcare", icon: "🏥", metricKey: "caseStudies.industries.metrics.healthcare" },
            { nameKey: "caseStudies.industries.list.finance", icon: "🏦", metricKey: "caseStudies.industries.metrics.finance" },
            { nameKey: "caseStudies.industries.list.education", icon: "🎓", metricKey: "caseStudies.industries.metrics.education" },
            { nameKey: "caseStudies.industries.list.realEstate", icon: "🏠", metricKey: "caseStudies.industries.metrics.realEstate" },
            { nameKey: "caseStudies.industries.list.hospitality", icon: "🏨", metricKey: "caseStudies.industries.metrics.hospitality" },
            { nameKey: "caseStudies.industries.list.retail", icon: "🏪", metricKey: "caseStudies.industries.metrics.retail" },
            { nameKey: "caseStudies.industries.list.automotive", icon: "🚗", metricKey: "caseStudies.industries.metrics.automotive" },
            { nameKey: "caseStudies.industries.list.insurance", icon: "🛡️", metricKey: "caseStudies.industries.metrics.insurance" },
            { nameKey: "caseStudies.industries.list.manufacturing", icon: "🏭", metricKey: "caseStudies.industries.metrics.manufacturing" },
            { nameKey: "caseStudies.industries.list.travel", icon: "✈️", metricKey: "caseStudies.industries.metrics.travel" },
            { nameKey: "caseStudies.industries.list.logistics", icon: "📦", metricKey: "caseStudies.industries.metrics.logistics" }
          ].map((industry, index) => (
