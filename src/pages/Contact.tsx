      ...
      <Section background="gradient">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl font-bold mb-6 text-gray-900">
            {t('contact.hero.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.hero.titleHighlight')}</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.features.consultation.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.features.consultation.description')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Calendar className="w-8 h-8 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.features.response.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.features.response.description')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Rocket className="w-8 h-8 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.features.implementation.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.features.implementation.description')}</p>
            </div>
          </div>
        </div>
      </Section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="border-none shadow-xl">
              <CardHeader>
                <CardTitle className="text-3xl font-bold text-gray-900">
                  {t('contact.form.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.form.titleHighlight')}</span>
                </CardTitle>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => handleInputChange("areaOfInterest", value)} required>
                      ...
                      <SelectContent>
                        <SelectItem value="demo">{t('contact.form.interests.demo')}</SelectItem>
                        <SelectItem value="pricing">{t('contact.form.interests.pricing')}</SelectItem>
                        <SelectItem value="integration">{t('contact.form.interests.integration')}</SelectItem>
                        <SelectItem value="enterprise">{t('contact.form.interests.enterprise')}</SelectItem>
                        <SelectItem value="support">{t('contact.form.interests.support')}</SelectItem>
                        <SelectItem value="partnership">{t('contact.form.interests.partnership')}</SelectItem>
          ...
          <div className="space-y-8">
            ...
            <Card className="border-none shadow-xl">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-gray-900">
                  {t('contact.info.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.info.titleHighlight')}</span>
                </CardTitle>
              </CardHeader>
            ...
            <Card className="border-none shadow-xl">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-gray-900">
                  {t('contact.map.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.map.titleHighlight')}</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <Section background="gray">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">
            {t('contact.thanks.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.thanks.titleHighlight')}</span>!
          </h2>
