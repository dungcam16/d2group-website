        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.hero.consultation.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.hero.consultation.description')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Calendar className="w-8 h-8 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.hero.response.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.hero.response.description')}</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center">
                <Rocket className="w-8 h-8 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-2">{t('contact.hero.implementation.title')}</h3>
              <p className="text-gray-600 text-sm">{t('contact.hero.implementation.description')}</p>
            </div>
          </div>
        </div>
      </Section>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      <span className="text-blue-600 font-semibold">{t('contact.info.emergency')}</span>
                    </p>
                  </div>
                </div>
              </CardContent>
      ...
      <Section background="gray">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">
            {t('contact.success.title')} <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{t('contact.success.titleHighlight')}</span>!
          </h2>
