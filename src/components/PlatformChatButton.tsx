...
import { Phone, Send, Users, MessageCircle, Menu } from "lucide-react";
    ...
    <DropdownMenu>
      ...
      >
        <div className="p-2 border-b border-gray-100">
          <span className="text-sm font-semibold text-gray-700">Các platform khác</span>
        </div>
...
export default PlatformChatButton;
