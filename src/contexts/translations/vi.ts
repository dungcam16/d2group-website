...
export const viTranslations: Translations = {
  ...
  // Pricing Page - NEW TRANSLATIONS
  'pricing.hero.title': 'Bảng giá',
  'pricing.hero.titleHighlight': 'minh bạch',
  'pricing.hero.description': 'Chọn gói phù hợp với nhu cầu kinh doanh của bạn. Tất cả gói đều bao gồm dùng thử miễn phí 14 ngày.',
  ...
  'pricing.comparison.subtitle': 'So sánh tất cả tính năng trên các gói bảng giá của chúng tôi.',
  ...
  'pricing.comparison.websiteWidget': 'Widget trang web',
  'pricing.comparison.websiteWidgetIntegration': 'Tích hợp Widget trang web',
  ...
  'pricing.faq.a2': 'Có - bạn có thể chuyển đổi gói bất cứ khi nào bạn muốn. Nâng cấp có hiệu lực ngay lập tức; hạ cấp áp dụng vào chu kỳ thanh toán tiếp theo.',
  'pricing.faq.q3': 'Có dùng thử miễn phí không?',
  'pricing.faq.a3': 'Có - chúng tôi cung cấp dùng thử miễn phí 14 ngày cho tất cả gói. Không cần thẻ tín dụng và bạn có thể hủy bất cứ lúc nào trong thời gian dùng thử.',
  'pricing.faq.q4': 'Điều gì xảy ra nếu tôi vượt quá giới hạn phiên chat?',
  'pricing.faq.a4': 'Nếu bạn vượt quá hạn ngạch hàng tháng, các phiên bổ sung sẽ được tính phí 3$ cho mỗi phiên. Chúng tôi sẽ gửi thông báo khi bạn gần đạt giới hạn.',
  
  // Final CTA Section
  'pricing.cta.title': 'Sẵn sàng',
  'pricing.cta.titleHighlight': 'bắt đầu',
  'pricing.cta.subtitle': 'Bắt đầu dùng thử miễn phí ngay hôm nay và khám phá cách chatbot AI của D2 Group có thể chuyển đổi cuộc trò chuyện khách hàng của bạn. Không cần thẻ tín dụng - hủy bất cứ lúc nào.',
  'pricing.cta.startFreeTrial': 'Bắt đầu dùng thử miễn phí',
  'pricing.cta.contactSales': 'Liên hệ bán hàng',
  'pricing.cta.questionsHelp': 'Có câu hỏi? Đội ngũ bán hàng của chúng tôi sẵn sàng giúp bạn chọn gói phù hợp.'
};
