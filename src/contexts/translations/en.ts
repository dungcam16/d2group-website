...
export const enTranslations: Translations = {
  ...
  'home.hero.description':
    'Automate customer support, boost sales, and elevate user experience with our cutting-edge AI chatbot solutions. Join 1,000+ businesses already transforming their customer conversations.',
  ...
  'about.hero.description':
    'Founded in 2019, D2 Group has been at the forefront of AI-chatbot technology, helping businesses across Southeast Asia reinvent their customer interactions.',
  'about.stats.clients': 'Happy Clients',
  'about.stats.countries': 'Countries Served',
  'about.stats.uptime': 'Service Uptime',
  'about.mission.title': 'Our Mission & Values',
  'about.mission.description':
    'We democratize AI so that businesses of any size can forge meaningful connections with their customers through intelligent automation.',
  ...
  'about.cta.description':
    'Let us help you transform customer engagement with our proven AI-chatbot solutions.',
  ...
  'features.hero.description':
    'Explore the complete suite of AI-powered capabilities that make our chatbots the smartest choice for growing brands.',
  ...
  'features.core.nlp.desc':
    'Our AI understands context, intent, and nuance in every conversation',
  'features.core.nlp.detail1':
    'Multilingual support – including English, Vietnamese, and Thai',
  ...
  'features.core.realTime.desc':
    'Comprehensive analytics to optimize chatbot performance',
  ...
  'features.core.security.desc':
    'Bank-level security that protects your business and customer data',
  ...
  'features.core.conversations.desc':
    'Human-like interactions that truly help your customers',
  ...
  'features.comparison.subtitle':
    'Discover how AI chatbots outperform legacy customer-support methods',
  ...
  'features.advanced.ai.conversationFlow.desc':
    'AI adapts flows automatically based on user behaviour',
  'features.advanced.ai.intentTraining.name': 'Custom Intent Training',
  'features.advanced.ai.intentTraining.desc':
    'Train the AI on your unique business terminology',
  'features.advanced.ai.autoLearning.name': 'Continuous Learning',
  'features.advanced.ai.autoLearning.desc':
    'The model gets smarter with every interaction',
  'features.advanced.ai.fallbackHandling.name': 'Smart Fallback Handling',
  'features.advanced.ai.fallbackHandling.desc':
    'Graceful escalation to human agents for complex queries',
  ...
  'features.advanced.integration.ecommerce.desc':
    'Native connectors for Shopify, WooCommerce, Magento',
  ...
  'features.advanced.analytics.conversation.desc':
    'Deep insights into customer-conversation patterns',
  'features.advanced.analytics.performance.name': 'Performance Metrics',
  'features.advanced.analytics.performance.desc':
    'Track KPIs such as resolution rate, satisfaction scores, and conversion metrics',
  ...
  'features.advanced.analytics.abTesting.desc':
    'Test different conversation flows and optimise performance',

  // Demo
  'features.demo.title': 'See It in',
  'features.demo.titleHighlight': 'Action',
  'features.demo.description':
    'Experience our AI-chatbot capabilities with an interactive demo',
  'features.demo.interactive.title': 'Interactive Demo Available',
  'features.demo.interactive.description':
    'Put our chatbot to the test in a live environment',
  ...
  'home.why.subtitle':
    'Forward-thinking brands trust D2 Group for AI-driven customer experiences that deliver measurable results.',
  'home.why.ai.title': 'Advanced AI Technology',
  'home.why.ai.desc':
    'Our chatbots use cutting-edge NLP to understand and respond like humans.',
  'home.why.security.title': 'Enterprise Security',
  'home.why.security.desc':
    'End-to-end encryption and GDPR compliance for complete peace of mind.',
  'home.why.results.title': 'Proven Results',
  'home.why.results.desc':
    'Clients see an average 40% uplift in conversions and a 60% drop in support costs.',
  ...
  'home.features.analytics.desc':
    'Detailed insights into customer interactions and behaviour',
  ...
  'home.howItWorks.step1.desc':
    'Use our intuitive builder to craft flows tailored to your business.',
  'home.howItWorks.step2.title': 'Train & Customise',
  'home.howItWorks.step2.desc':
    'Upload data and refine responses to match your brand voice.',
  'home.howItWorks.step3.title': 'Deploy & Monitor',
  'home.howItWorks.step3.desc':
    'Launch across channels and track performance with real-time analytics.',
  ...
  'home.testimonials.3.content':
    'The chatbot now resolves 80% of student questions automatically, freeing our team for deeper academic support.',
  ...
  'home.faq.a1':
    'Most businesses can launch a basic chatbot within 24-48 hours. Complex customisations may take 1-2 weeks.',
  'home.faq.q2': 'Do you provide training and support?',
  'home.faq.a2':
    'Absolutely. We offer comprehensive training, 24/7 support, and a dedicated account manager.',
  'home.faq.q3': 'Can the chatbot integrate with existing systems?',
  'home.faq.a3':
    'Yes. Our platform integrates with CRMs, helpdesks, e-commerce platforms, and other business apps.',
  ...
  'home.finalCta.description':
    'Join thousands of businesses already using D2 Group AI chatbots to elevate customer experience and drive growth.',
  ...
  'pricing.hero.description':
    'Pick the perfect plan for your needs. Every plan includes a free 14-day trial.',
  ...
  'pricing.faq.a1':
    'A chat session is recorded each time a unique user interacts with your chatbot within a 24-hour window, regardless of message count.',
  ...
  'pricing.cta.description':
    'Start your free trial today and discover how D2 Group AI chatbots transform customer conversations. Cancel anytime.',
  'pricing.cta.startFreeTrial': 'Start Free Trial',
  'pricing.cta.contactSales': 'Contact Sales',
  'pricing.cta.questionsText':
    'Have questions? Our sales team will help you choose the right plan.',
