...
export const enTranslations: Translations = {
  ...
  'pricing.hero.description': 'Choose the perfect plan for your business needs. All plans include a free 14-day trial.',
  ...
  'pricing.faq.a1': 'A chat session is counted each time a unique user interacts with your chatbot within a 24-hour period, regardless of the number of messages exchanged.',
  'pricing.faq.q2': 'Can I upgrade or downgrade my plan anytime?',
  'pricing.faq.a2': 'Yes—you can switch plans at any time. Upgrades take effect immediately; downgrades apply at your next billing cycle.',
  ...
  'pricing.faq.a4': 'If you exceed your monthly quota, additional sessions are charged at $3 per session. We\'ll notify you when you\'re approaching your limit.',

  // Final CTA
  'pricing.cta.title': 'Ready to',
  'pricing.cta.titleHighlight': 'Get Started',
  'pricing.cta.question': '?',
  'pricing.cta.description': 'Start your free trial today and discover how D2 Group\'s AI chatbots can transform your customer conversations. No credit card required—cancel anytime.',
  'pricing.cta.startFreeTrial': 'Start Free Trial',
  'pricing.cta.contactSales': 'Contact Sales',
  'pricing.cta.questionsText': 'Have questions? Our sales team is here to help you choose the right plan.',
